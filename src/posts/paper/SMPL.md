...
![Fig. 1: Overview](http://img.rocyan.cn/blog/2024/05/664b3a389f489.png)
...
![Fig. 2: SMPL模型的24个关节](http://img.rocyan.cn/blog/2024/04/6612bb070251f.png =x400)
...
![Fig. 3: 平均模板的 mesh，混合权重用颜色表示，关节用白点表示](http://img.rocyan.cn/blog/2024/04/6612bb070251f.png =x400)
...
![Fig. 4: 在平均模板上加上基于形状的偏移并且预测关节](http://img.rocyan.cn/blog/2024/04/6612bb0b8f75d.png =x400)

### 基于姿态的混合成形 (Pose Blend Shapes)

不同的 pose 也会改变人物的 shape，比如弯腰的时候肚子上的肉会压缩，视觉上可能会显得变大。所以先把某一帧的 pose 导致的 shape 的改变加到 T-pose 下。

![Fig. 5: 姿态对 T-pose 下的 shape 的影响](http://img.rocyan.cn/blog/2024/04/6612bb0f3c6ee.png =x400)
...
![Fig. 6: 蒙皮后的模型](http://img.rocyan.cn/blog/2024/04/6612bb127a080.png =x400)
...
![Fig. 7: 骨骼点位置估计的可视化](http://img.rocyan.cn/blog/2024/04/6612bb16612c7.png =x400)
