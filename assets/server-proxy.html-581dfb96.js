...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-获取-google-drive-文件链接-id" tabindex="-1"><a class="header-anchor" href="#_3-2-获取-google-drive-文件链接-id" aria-hidden="true">#</a> 3.2 获取 Google Drive 文件链接/ID</h3><figure><img src="http://rocyan.oss-cn-hangzhou.aliyuncs.com/notes/7r9572.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>通过以上步骤可以获取文件的 ID，<code>https://drive.google.com/file/d/12DmrxXNtl0U9hnN1bzue4XX7nw1fSMZ5/view?usp=share_link</code> 其中 <code>12DmrxXNtl0U9hnN1bzue4XX7nw1fSMZ5</code> 就是文件的 ID，最后的链接是 <code>https://drive.google.com/uc?id=&lt;文件ID&gt;</code>。并且文件的访问权限必须是”互联网上知道链接的任何人都可以查看“。</p><figure><img src="http://rocyan.oss-cn-hangzhou.aliyuncs.com/notes/9s0jdv.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>如果直接用共享的文件可能会遇到超出下载配额的问题，所以建议保存到自己的云盘后再下载。网页版的谷歌云盘经常没有反应，所以建议下载桌面版云端云盘后再操作。</p><h3 id="_3-3-使用-gdown-下载" tabindex="-1"><a class="header-anchor" href="#_3-3-使用-gdown-下载" aria-hidden="true">#</a> 3.3 使用 gdown 下载</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 使用链接下载文件</span>
